...
public class DataPointsList extends DataMapObject implements SerialisableContent{
	...
	/**
	 * Setter-method
	 * @param isArea is Object an Area
	 */
	...
	/**
	 * Add a new Node at the end of the list. Call this method if you want
	 * to extend the Way or Area.
	 ...
	 */
	 ...
	 /**
	 * Add a new Node at the end of the list. Call this method if you want
	 * to extend the Way or Area. Additionally the Location-constructor
	 * of the DataNode is called.
	 * @return the newly created DataNode.
	 */
	  ...
	  * @param id the id of the PointsList to load from the devices memory.
